package me.test.util.unix.prococol.ssh2.compression;

import me.test.util.unix.prococol.ssh2.jzlib.JZlib;
import me.test.util.unix.prococol.ssh2.jzlib.ZStream;

public class Compression implements me.test.util.unix.prococol.ssh2.Compression {
